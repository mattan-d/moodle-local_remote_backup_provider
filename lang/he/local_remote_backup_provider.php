...
$string['remove_old_task'] = 'הסר קבצי גיבוי מרוחק ישנים';
$string['import'] = 'יבוא קורס משרת מרוחק';
$string['pluginname'] = 'יבוא קורסים משרת מרוחק';
